...
2) The 12pin connector is a 12V power connector and you can prepare it in a few ways, but the best is probably to use 8pin EPS connector + 4pin cpu connector and just plug them next to each other. No repin required. Alternatively, if you have a spare 20/24pin ATX connector, you can do the same as for the 18pin connector.
